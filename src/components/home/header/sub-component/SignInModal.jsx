                    ...
                    <div className="modalAnimation p flex h-auto flex-col gap-[30px] items-center py-7 sm:w-[90vw] w-[100vw] xl:w-[80vw]  p-7 bg-white left-[50%] top-[50%] -translate-x-[50%] -translate-y-[50%] fixed">
                        <div className="flex w-full h-full">
                            <div className="w-[50%] content-text px-[20px] pr-[40px] flex gap-[15px] flex-col">
                                ...
                                <form action="#" className="flex flex-col gap-[15px] mt-6 w-full">
                                ...
                                <div className="flex justify-center items-center text-[16px] leading-[24px]">
                                    <p className="text-[#696F79] font-[500]">already have an account? <span onClick={handleShowSignUpModal} className="text-[#0E385C] text-[17px] font-[590] cursor-pointer font">Register</span></p>
                                </div>
                            </div>
