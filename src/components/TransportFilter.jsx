...
export function TransportFilter({ onSubmit }) {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      {loading && <div className="text-black font-[590] text-xl border px-4 mt-2 bg-white rounded-md">Loading...</div>}
      {error && <div className="text-red-600 font-[590] text-xl border px-4 mt-2 bg-white rounded-md">{error}</div>}
    </div>
  );
}
